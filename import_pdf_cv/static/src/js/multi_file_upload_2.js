...
export class MultifileUploader extends Component {
    static template = "import_pdf_cv.MultifileUploader";
...
registry.category("actions").add("import_pdf_cv_multifile_uploader", MultifileUploader);
